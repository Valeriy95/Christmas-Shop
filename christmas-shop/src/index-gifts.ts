...
const giftsCardContainer = document.querySelector(
  '.gifts-card-container',
) as HTMLElement
const giftsTabAll = document.querySelector('.gifts-tab__1') as HTMLElement

const giftsTabForWork = document.querySelector('.gifts-tab__2') as HTMLElement

const giftsTabForHealth = document.querySelector('.gifts-tab__3') as HTMLElement

const giftsTabForHarmony = document.querySelector(
  '.gifts-tab__4',
) as HTMLElement
...
function findGiftByCategory(text: string) {
    ...
    giftsCard.addEventListener('click', function (e) {
      ...
      if (attributeName) {
        if (findGiftByName(attributeName)) {
          const currentGiftObj: giftsObjectType = findGiftByName(attributeName)
...
function findGiftByName(name: string) {
  return giftsObject.find((gift) => gift.name === name) as giftsObjectType
}
